...
const topics_core: TopicData[] = [
  ...
  // ─── 22. DIRECT FM GENERATION ───
  {
    ...
    numericals: [
      {
        id: "dfm-1",
        title: "Varactor Capacitance Change",
        difficulty: "Easy",
        given: "f₀ = 100 MHz, Δf = 75 kHz, C₀ = 50 pF",
        formula: "ΔC/C₀ = 2Δf/f₀",
        steps: [
          "ΔC/C₀ = 2 × 75×10³ / 100×10⁶",
          "= 150000 / 10⁸ = 1.5 × 10⁻³",
          "ΔC = 1.5×10⁻³ × 50 = 0.075 pF",
        ],
        answer: "ΔC = 0.075 pF (very small variation)",
      },
      {
        id: "dfm-2",
        title: "VCO Linearity",
        difficulty: "Medium",
        given: "VCO sensitivity = 50 kHz/V, m(t) range = ±1.5V",
        formula: "Δf = sensitivity × m_peak",
        steps: [
          "Δf = 50 × 1.5 = 75 kHz",
          "fi ranges from fc - 75 to fc + 75 kHz",
          "For B = 15 kHz: β = 75/15 = 5",
          "BW = 2(75+15) = 180 kHz",
        ],
        answer: "Δf = 75 kHz, β = 5, BW = 180 kHz",
      },
      {
        id: "dfm-3",
        title: "AFC Loop Design",
        difficulty: "Hard",
        given: "Frequency drift = ±5 kHz, VCO gain = 50 kHz/V, loop gain = 100",
        formula: "Residual error = drift / (1 + loop_gain)",
        steps: [
          "Without AFC: drift = ±5 kHz",
          "With AFC: residual = 5000/(1+100) = 49.5 Hz",
          "Improvement factor = 101 (40 dB)",
          "Residual drift is negligible for broadcast FM",
        ],
        answer: "Residual drift ≈ 49.5 Hz (from ±5 kHz)",
      },
    ],
  },
];
...
const noiseTopics: TopicData[] = [
  ...
  },
  {
    ...
    theory: {
      points: [
        "Signal-to-Noise Ratio (SNR) is the fundamental measure of communication system quality.",
        "For AM with envelope detection: SNR_out = μ²S_i / (2+μ²)N_i, showing a threshold effect.",
        "FM provides SNR improvement over AM: SNR_FM / SNR_AM = 3β²(β+1), called the FM advantage.",
        "Pre-emphasis and de-emphasis further improve FM SNR by 13 dB for broadcast standards.",
      ],
      formulas: [
        { label: "AM SNR", expression: "\\text{SNR}_{AM} = \\frac{\\mu^2 P_c}{2N_0 B}" },
        { label: "FM Advantage", expression: "\\frac{\\text{SNR}_{FM}}{\\text{SNR}_{AM}} = 3\\beta^2(\\beta + 1)" },
      ],
    },
